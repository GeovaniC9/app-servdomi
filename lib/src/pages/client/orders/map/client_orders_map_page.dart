...
import 'package:flutterservidomisti/src/pages/client/address/list/client_address_list_controller.dart';
import 'package:flutterservidomisti/src/pages/client/address/map/client_address_map_controller.dart';
import 'package:flutterservidomisti/src/pages/client/orders/map/client_orders_map_controller.dart';
import 'package:flutterservidomisti/src/pages/delivery/orders/map/delivery_orders_map_controller.dart';
import 'package:flutterservidomisti/src/utils/my_colors.dart';
import 'package:flutterservidomisti/src/widgets/no_data_widget.dart';
  ...
  Widget _cardOrderInfo() {
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            _listTileAddress(_con.order?.address?.neighborhood, 'Colonia',
                Icons.my_location),
            _listTileAddress(
                _con.order?.address?.address, 'Direccion', Icons.my_location),
