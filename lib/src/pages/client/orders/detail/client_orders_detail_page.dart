...
import 'package:flutterservidomisti/src/pages/admin/orders/detail/admin_orders_detail_controller.dart';
import 'package:flutterservidomisti/src/pages/client/orders/detail/client_orders_detail_controller.dart';
import 'package:flutterservidomisti/src/pages/delivery/orders/detail/delivery_orders_detail_controller.dart';
import 'package:flutterservidomisti/src/utils/my_colors.dart';
import 'package:flutterservidomisti/src/utils/relative_time_util.dart';
...
class _ClientOrdersDetailPageState extends State<ClientOrdersDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Pedido #${_con.order?.id ?? ''}'),
        actions: [
          Container(
