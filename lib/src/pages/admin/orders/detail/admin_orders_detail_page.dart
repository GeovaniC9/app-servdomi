...
class AdminOrdersDetailPage extends StatefulWidget {
  ...
  AdminOrdersDetailPage({Key key, @required this.order}) : super(key: key);

  @override
  _AdminOrdersDetailPageState createState() => _AdminOrdersDetailPageState();
}

class _AdminOrdersDetailPageState extends State<AdminOrdersDetailPage> {
  AdminOrdersDetailController _con = new AdminOrdersDetailController();
